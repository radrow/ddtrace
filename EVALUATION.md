...
*Example 3.10* in the paper). Therefore, the logs generated by some executions
of the test scenario may not report any deadlock, while other executions may
show deadlocks occurring at different times. It may **take a few retries** to
obtain a deadlock and a detection log that closely correspond to *Listings 2, 3,
and 4* in the paper.

*NOTE:* The output log may contain additional entries and be formatted slightly
differently compared to listings in the companion paper.
